...
public class PaymentPagingSellAction_gy implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		//비지니스
				...
				//데이터 처리
				System.out.println("리스트 보더 서비스 2 밖");
				PaymentPagingDTO_gy listModel = daoservice.listBoardService2(requestPage, request);
