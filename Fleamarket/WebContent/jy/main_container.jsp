					...
					<a href="detailAction.do?itemboard_no=${reList.itemboard_no}">
						<div class="reco-item">
							<table class="tg">
								...
								<tr>
									<td class="tg-phtq" colspan="2">${reList.title}</td>
								</tr>
								<tr>
									<c:choose>
										<c:when test="${reList.delivery_fee eq 1}">
		...
		<div class="hot-item">
			...
			<c:forEach var="list" items="${bean.hotList}">
				...
				<c:forEach var="itemList" items="${list.hotList}">
					<a href="detailAction.do?itemboard_no=${itemList.itemboard_no}">
						<div class="reco-item">
							<table class="tg2">
								...
								<tr>
									<td class="tg-oe15" colspan="2">${itemList.title}</td>
								</tr>
								<tr>
									<td class="tg-oe15">${itemList.price}</td>
